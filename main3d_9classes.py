...
from src.Dataset.dataset import CustomDatasetHW , CustomDatasetHW_3D # or your appropriate dataset
from src.utils.losses import GeneralizedDiceLoss, DiceLoss
from src.utils.utils import custom_collate_Variable_HW, custom_collate_Variable_HW_9classes
...
def main():
    ...
    loss_fn = DiceLoss(normalization='sigmoid')
    ...
    train_loader = DataLoader(
        ...
        shuffle=True,
        collate_fn=custom_collate_Variable_HW_9classes,
    )
